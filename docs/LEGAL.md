...
"Nyx Backup", the Nyx Backup logo, and "AltDrive" are trademarks of
AltDrive, LLC.  The Apache-2.0 license grants rights to the **source code** only;
...
- You may fork and redistribute this code, but a redistributed or
  ...
  that implies endorsement by or affiliation with AltDrive, LLC.
...
verifying restored data.  AltDrive, LLC is not liable for any data loss,
...
AltDrive, LLC - https://nyxbackup.com - legal@nyxbackup.com
